...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh doesn't show full-screen loading to avoid flicker
...
onMounted(() => {
  ...
  // Log maxRounds config (value already obtained from query params at initialization)
  if (maxRounds.value) {
