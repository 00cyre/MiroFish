...
[Returns]
- Related fact excerpts (can be directly quoted)
- Core entity insights
- Relationship chain analysis"""

TOOL_DESC_PANORAMA_SEARCH = """\
[Panoramic Search - Full Picture View]
This tool is used to get the complete picture of simulation results, especially for understanding event evolution. It will:
...
SECTION_SYSTEM_PROMPT_TEMPLATE = """You are an expert in writing "Future Prediction Reports," currently writing a section of the report.
...
3. [Language Consistency - Quoted Content Must Match Report Language]
   ...
   - The report should be written in a language consistent with the simulation requirements and source materials
   - When quoting content from tools, translate it into the report's language for fluent presentation
...
- Do NOT add section headings at the beginning of content
...
Platform A served as the first scene of public opinion, with the core function of initial information release:
...
6. [Avoid Repetition] Carefully read completed sections below and do not repeat the same information
7. [Emphasis] Do not add any headings! Use **bold text** instead of sub-section headings"""

SECTION_USER_PROMPT_TEMPLATE = """Completed section content (please read carefully to avoid repetition):
{previous_content}
...
REACT_FORCE_FINAL_MSG = "Tool invocation limit reached. Please directly output Final Answer: and generate section content."
...
3. Only invoke tools when report content is insufficient to answer
...
class ReportAgent:
    ...
    2. Generation phase: Generate content section by section, each can call tools multiple times
    ...
    def _define_tools(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "interview_agents": {
                ...
                "parameters": {
                    "interview_topic": "Interview topic or requirement (e.g., 'understand students views on dormitory formaldehyde incident')",
    ...
    def _parse_tool_calls(self, response: str) -> List[Dict[str, Any]]:
        ...
        # Only attempted when Format 1 does not match, to avoid false matches in body text
    ...
    def _generate_section_react(
        ...
        # Build user prompt - pass in max 4000 chars per completed section
        ...
        for iteration in range(max_iterations):
            ...
            if response is None:
                ...
                if iteration < max_iterations - 1:
                    ...
                    continue
                # Last iteration also returned None, break loop for forced finalization
                break
            ...
            # Use this content directly as final answer, no more idle loops
            logger.info(f"Section {section.title}: 'Final Answer:' prefix not detected, accepting LLM output directly as final content (tool calls: {tool_calls_count})")
    ...
    def chat(
        ...
        In conversation, Agent can autonomously invoke retrieval tools to answer questions
...
class ReportManager:
    ...
    def get_console_log(cls, report_id: str, from_line: int = 0) -> Dict[str, Any]:
        ...
        return {
            ...
            "from_line": from_line,
            "has_more": False  # Already read to end of file
        }
    ...
    def _clean_section_content(cls, content: str, section_title: str) -> str:
        ...
        1. Remove Markdown heading lines that duplicate the section title at the beginning
    ...
    def assemble_full_report(cls, report_id: str, outline: ReportOutline) -> str:
        ...
        # Post-process: clean heading issues across the full report
    ...
    def _post_process_report(cls, content: str, outline: ReportOutline) -> str:
        ...
        3. Clean up excessive blank lines and separators
        ...
        while i < len(lines):
            ...
            if heading_match:
                ...
                # Check for duplicate heading (same title content within 5 consecutive lines)
                is_duplicate = False
        ...
        # Clean multiple consecutive empty lines (keep max 2)
        result_lines = []
        empty_count = 0
