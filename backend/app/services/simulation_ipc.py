...
Implements a simple command/response pattern through the file system:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview on both platforms for dual-platform simulations, or the active platform for single-platform simulations
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Interview each agent on both platforms for dual-platform simulations
            timeout: Timeout in seconds
