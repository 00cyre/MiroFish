...
from .pg_entity_reader import EntityNode, ZepEntityReader
...
class OasisProfileGenerator:
    ...
    Converts entities from Zep graph to Agent Profiles required for OASIS simulation

    Optimization features:
    1. Uses Zep graph retrieval to get richer context
    ...
    # Group/organization entity types (require generating representative account personas)
    GROUP_ENTITY_TYPES = [
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Search for rich information related to the entity.

        Previously used Zep Cloud graph search; now returns empty results
        since graph data lives in Postgres/NetworkX.
        TODO: Implement PG-backed entity context search.
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        """
        Build complete context information for the entity

        Includes:
        1. Edge information (facts) of the entity itself
        2. Detailed information of related nodes
        3. Rich information retrieved via entity search
        """
        context_parts = []
        ...
        # 4. Search for additional entity context (TODO: implement PG-backed search)
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Determine if this is a group/organization entity type"""
    ...
    def _generate_profile_with_llm(
        ...
        - Group/organization entities: Generate representative account profiles
        """
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for public opinion simulation, faithfully recreating existing real-world situations as much as possible. Must return valid JSON format, all string values must not contain unescaped newlines. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, faithfully recreating existing real-world situations as much as possible.
...
2. persona: Detailed persona description (2000 words of plain text), should include:
   ...
   - Stances and opinions (attitude toward topics, content that may provoke or move them)
...
6. country: Country (e.g., "United States")
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for an institutional/group entity, faithfully recreating existing real-world situations as much as possible.
...
2. persona: Detailed account profile description (2000 words of plain text), should include:
   ...
   - Stances and attitudes (official position on core topics, approach to handling controversies)
   - Special notes (representative group profile, operational habits)
   - Institutional memories (an important part of the persona; describe this institution's connection to events and its existing actions and reactions within those events)
...
- Institutional account communications must align with its identity and positioning"""
    ...
    def _generate_profile_rule_based(
        ...
        """Generate basic profile using rules"""

        # Generate different profiles based on entity type
    ...
    def set_graph_id(self, graph_id: str):
        """Set graph ID for entity context retrieval"""
        self.graph_id = graph_id
    ...
    def generate_profiles_from_entities(
        ...
        """
        Generate Agent Profiles from entities in batch (supports parallel generation)
        ...
        Args:
            ...
            graph_id: Graph ID for entity context retrieval
        ...
        # Set graph_id for entity context retrieval
        if graph_id:
            self.graph_id = graph_id
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            ...
            try:
                ...
                # Output generated profile to console and log in real time
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        """Output generated profile to console in real time (full content, no truncation)"""
        separator = "-" * 70
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        - user_id: User ID (sequential starting from 0)
