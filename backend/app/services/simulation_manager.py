...
from .pg_entity_reader import ZepEntityReader, FilteredEntities
...
class SimulationState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Full state dict (for internal use)"""
        return {
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            # Note: Run scripts remain in backend/scripts/ directory and are no longer copied to simulation directory
