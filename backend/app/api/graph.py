...
from ..services.graph_builder_pg import GraphBuilderService
...
def build_graph():
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is currently being built, please do not submit again. To force a rebuild, add force: true",
