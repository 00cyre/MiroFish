...
def generate_report():
    ...
    try:
        ...
        # Generate report_id ahead of time so it can be returned to the frontend immediately
        import uuid
...
def chat_with_report_agent():
    ...
    The Report Agent can autonomously call retrieval tools to answer questions during conversation.
...
def get_agent_log(report_id: str):
    ...
    Retrieve each step during the report generation process in real-time, including:
...
def get_console_log(report_id: str):
    ...
    Retrieve console output (INFO, WARNING, etc.) during the report generation process in real-time.
